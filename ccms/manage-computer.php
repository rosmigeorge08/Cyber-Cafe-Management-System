...
?>
  ...
  <td><form method = 'post' >
<input type="hidden" name="cname" value="<?php echo $row['ComputerName'];?>" /><input type="submit"  name="delete" value ="Delete">
  </form>
                </tr>
                <?php 
$cnt=$cnt+1;
...
{				
	$query = "DELETE FROM `tblcomputers` where ComputerName='".$_POST['cname']."'";
    // echo $query;

...
?>
             ...
             <td><?php  echo $row['EntryID'];?></td>
                  ...
                  <td><form method = 'post' >
<input type="hidden" name="uname" value="<?php echo $row['UserName'];?>" /><input type="submit"  name="delete" value ="Delete">
  </form>
                </tr>
                <?php 
$cnt=$cnt+1;
...
{				
	$query = "DELETE FROM `tblusers` where UserName='".$_POST['uname']."'";
    // echo $query;
